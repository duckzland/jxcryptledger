...
class TransactionsSimpleTreeCard extends StatefulWidget {
  final TransactionsModel tx;
  final IndexedTreeNode<TransactionsModel> node;
  final bool isActive;

  const TransactionsSimpleTreeCard({super.key, required this.tx, required this.node, required this.isActive});

  @override
  State<TransactionsSimpleTreeCard> createState() => _TransactionsSimpleTreeCardState();
}

class _TransactionsSimpleTreeCardState extends State<TransactionsSimpleTreeCard>
  ...
  @override
  void didUpdateWidget(covariant TransactionsSimpleTreeCard oldWidget) {
